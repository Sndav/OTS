...
class Course(models.Model):  # 课程
    ...
    desc = UEditorField("课程描述", imagePath='cimage/', filePath='cfile/')
    detail = UEditorField("课程详情", imagePath='cimage/', filePath='cfile/')
...
class LessonDetail(models.Model):
    ...
    detail = UEditorField('课程内容', imagePath='ldimage/', filePath='ldfile/')
    create_time = models.DateTimeField("添加时间", default=datetime.now)
    update_time = models.DateTimeField('更改时间', auto_now=True)
...
class LessonNote(models.Model):
    ...
    note = UEditorField('笔记内容', default='', imagePath='lnimage/', filePath='lnfile/')
    create_time = models.DateTimeField("添加时间", default=datetime.now)
    update_time = models.DateTimeField('更改时间', auto_now=True)
